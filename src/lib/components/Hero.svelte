<section class="bg-[#f5f5f5] px-6 pt-16 pb-0">
  <div class="max-w-[1400px] mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-16">
      <div class="lg:col-span-7">
        <h1 class="font-serif text-5xl md:text-6xl lg:text-[64px] leading-[1.1] tracking-tight text-gray-900">
          Free advisors from admin work with unified AI workflows
        </h1>
      </div>
      <div class="lg:col-span-5 flex flex-col justify-between">
        <p class="text-gray-500 text-lg max-w-md leading-relaxed">
          Nevis automates 80% of advisor admin tasks through intelligent workflows, letting your team focus on what matters: serving clients and growing your firm.
        </p>
      </div>
    </div>
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-8 border-t border-gray-200 pt-6">
      <div class="flex items-center gap-4">
        ...
        <span class="text-xs text-gray-500 max-w-[140px] leading-tight">
          Built for RIAs and growing wealth management firms
        </span>
      </div>
      <div class="text-[10px] text-gray-400 uppercase tracking-wider">
        $40M Series A · Dec 2025
      </div>
    </div>
    ...
    <div class="relative w-full h-[600px] overflow-hidden rounded-sm bg-gray-900">
      <!-- Image Overlay -->
      <img 
        src="/generated/image-professional-financial-advisor-meeting-w-1765401345871-0.webp" 
        alt="Financial advisor meeting with client" 
        class="absolute inset-0 w-full h-full object-cover opacity-50 mix-blend-overlay"
      />
      <div class="absolute inset-0 bg-gradient-to-tr from-gray-900/90 to-gray-800/60 mix-blend-multiply"></div>
      
      <!-- Curved Line Graphic -->
      <svg class="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 1400 600" fill="none" preserveAspectRatio="none">
        <!-- Main large curve -->
        <path d="M-100,600 C200,500 400,100 1500,50" stroke="white" stroke-width="1.5" stroke-opacity="0.3" vector-effect="non-scaling-stroke" />
        <!-- Secondary fainter curve -->
        <path d="M-100,600 C300,400 600,200 1500,300" stroke="white" stroke-width="1" stroke-opacity="0.12" vector-effect="non-scaling-stroke" />
      </svg>
